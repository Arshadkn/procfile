...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        if int(clicked) == typed:
            ...
            try:
                if AUTH_CHANNEL and not await is_subscribed(client, query):
                    ...
                    f'<b>➤ sɪᴢᴇ:</b> {size}\n\n'
                    f'<b><i> This File Will be Deleted within 5 Mins..! </i></b>',
                    True,
                    'html',
                ...
                await query.answer('ᴄʜᴇᴄᴋ "ɴs ғɪʟᴇ sᴛᴏʀᴇ" ғᴏʀ ʏᴏᴜʀ ғɪʟᴇ',show_alert=True)
        ...
        buttons = [[
            InlineKeyboardButton('ᴏᴡɴᴇʀ', url='http://t.me/peakytg')
        ], [
            InlineKeyboardButton('ʜᴏᴍᴇ', callback_data='start'),
    ...
    await query.answer('ᴏᴋ ʜᴜᴍᴀɴ!!', show_alert=True)
...
async def auto_filter(client, msg, spoll=False):
    ...
    if offset != "":
        ...
        btn.insert(0,
            [InlineKeyboardButton(text="𝗡𝗦 𝗙𝗜𝗟𝗘 𝗦𝗧𝗢𝗥𝗘",url="https://t.me/+5_aBrJ8UJbs0NDQ1")]
        )
    else:
        btn.append(
